    ...
    <div class="col-sm-12">
        ...
        <div class="box">
            <div class="box-header">
                ...
                {{ link_to("models/generate", "Generate", 'class': 'btn btn-primary pull-right') }}
            </div>
                ...
                <table class="table table-hover">
                    ...
                    {%- if models_dir is empty -%}
                        <tr class="warning">
                            <td colspan="5">
                                <p class="text-center">
                                    Sorry, Phalcon ModTools doesn't know where the models directory is.<br>
                    ...
                    {%- else -%}
                        {% for model in models %}
                            <tr>
                                ...
                                <td>
                                    {{ link_to("models/edit/" ~ rawurlencode(model.filename),
