...
/**
 * \ModTools\Controllers\ControllersController
 *
...
class ControllersController extends BaseController
{
    ...
    public function updateAction()
    {
        if (!$this->request->has('path') || !$this->request->has('code')) {
            ...
            return $this->redirect('controllers/list');
        }
        ...
        if (!file_exists($path)) {
            ...
            return $this->rredirect('controllers/list');
        }
    ...
    public function generateAction()
    {
        if ($this->request->isPost()) {
            try {
                ...
                return $this->response->redirect('controllers/list');
        ...
        if (!$controllersDir) {
            $this->flash->error(
                "Sorry, ModTools doesn't know where the controllers directory is. " .
